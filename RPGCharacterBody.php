...
class RPGCharacterBody{
	...
	public function getBodyType(){
		$arrBodyParts = array("belly" => $this->_intBelly, "breasts" => $this->_intBreasts, "legs" => $this->_intLegs, "butt" => $this->_intButt);
		sort($arrBodyParts);
		
		$strHighestPart = end($arrBodyParts);
		$strSecondHighestPart = prev($arrBodyParts);
		
		if($arrBodyParts[$strHighestPart] >= $arrBodyParts[$strSecondHighestPart] + 3){
			return $strHighestPart;
		}
		else{
			return "all";
		}
