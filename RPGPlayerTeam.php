<?php
	...
	class RPGPlayerTeam{
		...
		public function hasStatusEffect($strStatusEffectName){
			...
			if($this->_objPlayer->hasStatusEffect($strStatusEffectName)){
				$arrReturn[] = "getPlayer";
			}
			if($this->_objPartyOne != null && $this->_objPartyOne->hasStatusEffect($strStatusEffectName)){
				$arrReturn[] = "getPartyOne";
			}
			if($this->_objPartyTwo != null && $this->_objPartyTwo->hasStatusEffect($strStatusEffectName)){
				$arrReturn[] = "getPartyTwo";
			}
